...
export default () => {
  const projects = [
    {
      image:
        "https://images.unsplash.com/photo-1547480053-7d174f67b557?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80",
      title: "TodoList",
      ...
      details: {
        text:
          "Sorting, filtering, searching capabilities. Will have auth and a way to save todos.",
      },
    },
    {
      image:
      ...
      title: "Tech Blog",
      desciption:
        "Right now pretty bare. I'm going to redo in gatsby using config to build pages from markdown in site files",
    ...
    },
    {
      ...
      details: {
        text:
          "Future plans include, connections to graphQL, ability to leave comments, sign in, favorite newsStories and users, search by users... so much more",
      },
    },
    {
      image:
        "https://images.unsplash.com/photo-1485389630172-dac32ee0e253?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80",
      title: "Markdown",
      ...
      details: {
        text:
          "Automatically changes your work to markdown on preview screen. Plans include responsive design, toggle previewer, full markdown reference guide...",
      },
    },
    {
      image:
        "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80",
      title: "Calculator",
      ...
      details: {
        text:
          "to come... animation for buttons and operations being marked... for better user experience",
      },
    },
  ]
  return (
    <Layout>
      ...
      <div className="d-flex flex-column align-items-center w-100 mb-5">
        <h1 className="my-4">Jesse Henson</h1>
        <p>React, GraphQL, Gatsby, Python... VBA???</p>
      </div>
          ...
          <div className="card mb-5 mx-5">
            ...
            <div className="card-body">
              ...
              <a
                href={project.github}
                target="blank"
                className="btn rounded btn-dark mx-1"
              >
                Github
              </a>
              <a
                ...
                target="blank"
                className={` ${
                  project.disabled ? "disabled" : null
                } btn rounded btn-dark mx-1`}
              >
                Example
              </a>
              <a href="#" target="blank" className="btn rounded btn-dark mx-1">
                Details
              </a>
            </div>
          </div>
      ...
      <nav className="navbar sticky-bottom navbar-dark bg-dark ">
        <a
          ...
          target="blank"
          href="mailto:henson.jhenson.jesse@gmail.com"
        >
          Email
        </a>
        <a
          ...
          target="blank"
          href="https://github.com/JesseHenson"
        >
          Github
        </a>
      </nav>
